    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">DROPLIT Admin Domain</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-cog fa-fw"></i>Manage Tips&Tricks</a>
                        </li>
                        
                        <li>
                            <a href="tables.html"><i class="fa fa-cog fa-fw"></i>Manage News Articles</a>
                        </li>
                        
                        <li>
                            <a href="tables.html"><i class="fa fa-cog fa-fw"></i>Manage Geographics</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
